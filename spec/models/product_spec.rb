...
RSpec.describe Product, type: :model do
  ...
  describe 'Validations' do
    ...
    xit "is not valid without name and error message is correct" do
      subject.name = nil
    ...
    xit "is not valid without price and error message is correct" do
    ...
    xit "is not valid without quantity and error message is correct" do
    ...
    xit "is not valid without category and error message is correct" do
